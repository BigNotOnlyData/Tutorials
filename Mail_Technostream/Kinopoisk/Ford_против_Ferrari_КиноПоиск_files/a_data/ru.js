...
(function () {
    ...
    if (lang) {
        i18nLang = lang; // eslint-disable-line
    }
};
    ...
    if (interpolatedArgs.length && !Array.isArray(returnedKey)) {
        ...
        if (typeof interpolatedArgs[0] === "object"
            && !Array.isArray(interpolatedArgs[0])) {
